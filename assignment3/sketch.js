...
function restBody() {
  ...
  //earrings
  fill(255,0,0);
  arc(width/2+36,height/4-1,15,15,radians(30),radians(130)); //right
  fill(0);
  arc(width/2+36,height/4,10,10,radians(30),radians(130)); //inner right
  fill(255,0,0);
  arc(width/2-30,height/4-1,15,15,radians(50),radians(150)); //left
  fill(0);
  arc(width/2-30,height/4,10,10,radians(50),radians(150)); //inner left
...
//ignore this function - was playing around
function whoa() {
